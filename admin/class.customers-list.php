...
class Customers_Lists extends WP_List_Table{
    ...
    public function no_items(){
        echo esc_html__('No customers avaliable.', 'wpsii-smart-insightly');
    }
    ...
    function get_columns(){
        $columns = [
                'ID'                  => esc_html__('Id', 'wpsii-smart-insightly') , 
                'woocommerce_name'    => esc_html__('Name', 'wpsii-smart-insightly') , 
                'user_email'          => esc_html__('Email', 'wpsii-smart-insightly') , 
                'user_registered'     => esc_html__('Create Time', 'wpsii-smart-insightly') , 
