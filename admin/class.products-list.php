...
class Product_Lists extends WP_List_Table {
	...
	public function no_items() {
		echo esc_html__( 'No products avaliable.', 'wpsii-smart-insightly' );
	}
	...
	function get_columns() {
		$columns = [
			'ID'    => esc_html__( 'Product Id', 'wpsii-smart-insightly' ),
			'post_title'    => esc_html__( 'Product Name', 'wpsii-smart-insightly' ),
			'meta_value'    => esc_html__( 'Sku', 'wpsii-smart-insightly' ),
